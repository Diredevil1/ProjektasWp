    ...
    <div class="container-fluid">
        <div class="container">
            <div class="owl-carousel">
                ...
                <div>
                    <div class="card">
                        <div class="carousel-bg" style="background: url(wp-content/themes/TestProject/assets/images/Obedience.jpg);">
                        </div>
                        <div class="card-body">
                            <h4>Obedience</h4>
                ...
                <div>
                    <div class="card">
                        <div class="carousel-bg" style="background: url(wp-content/themes/TestProject/assets/images/coursing.jpg);">
                        </div>
                        <div class="card-body">
                            <h4>Coursing</h4>
                ...
                <div>
                    <div class="card">
                        <div class="carousel-bg" style="background: url(wp-content/themes/TestProject/assets/images/tracking.jpg);">
                        </div>
                        <div class="card-body">
                            <h4>Tracking</h4>
                            <p class="card-text">Some quick example text to build on the card title and make up the
                ...
                <div>
                    <div class="card">
                        <div class="carousel-bg" style="background: url(wp-content/themes/TestProject/assets/images/frisbee.jpg);">
                        </div>
                        <div class="card-body">
                            <h4>Frisbee</h4>
                            <p class="card-text">Some quick example text to build on the card title and make up the
                ...
                <div>
                    <div class="card">
                        <div class="carousel-bg" style="background: url(wp-content/themes/TestProject/assets/images/agility.jpg);">
                        </div>
                        <div class="card-body">
                            <h4>Agility</h4>
